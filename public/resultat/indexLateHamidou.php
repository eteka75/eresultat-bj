                ...
                <div class="col-md-4 col-xl-4 mt-2 print-w1 print-table">
                    ...
                    <div class="card my-3">
                        <div class="card-body">
                            ...
                            <?php
                             if(isset($R_final,$R_final->decision_jury) && count($R_final) && $R_final->decision_jury=="REFUSE(E)"){
                            ?>
                ...
                ?>
                    <div class="mt-1 text-left card p-2 pt-3 bg-dark shadow_ text-white">
                        <ul class="list-inline main-chart row px-3 text-center text-sm mb-0">
                            ...
                            <?php }
                            if(isset($R_final) && $R_final && $R_final->moyenne){
                            ?>
                            <li class="list-inline-item col-sm chart-border-left me-0">
                        ...
                        <table class="table border print-table rounded-lg table-responsive  mt-1 w-100 table-borderless mt-2">
                            ...
                            ?>
                             <?php
                                           ...
                                           ?>
                                    <tr class="bg-white ">
                                            <td class="pt-0 m-0">&nbsp;</td>
                                            <td colspan="4" class="text-uppercase mt-n3 pt-0 m-0">
                                            <b >Moyenne UE : </b> <?php if($moy >= 10){print '<span class="badge text-md p-1 border badge-success note">'.$moy.'</span>';}else print '<span class="badge text-md p-1 border note">'.$moy.'</span>'; ?>
                                            </td>
                                        </tr>
                                <?php
                                    }
                                ...
                                <?php
                                    ...
                                    <tr class="bg-white ">
                                            <td class="pt-0 m-0">&nbsp;</td>
                                            <td colspan="4" class="text-uppercase mt-n3 pt-0 m-0">
                                            <b >Moyenne UE : </b> <span class="badge text-md p-1 border  note"></b> <?php if($moy >= 10){print '<span class="badge text-md p-1 border badge-success note">'.$moy.'</span>';}else print '<span class="badge text-md p-1 border note">'.$moy.'</span>'; ?>
                                            </td>
                                        </tr>
                                <?php
                                    }
